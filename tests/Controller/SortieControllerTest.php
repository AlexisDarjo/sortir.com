...
class SortieControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'sortie[etat]' => 'Testing',
            'sortie[lieu]' => 'Testing',
            'sortie[siteOrganisateur]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setSiteOrganisateur('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setSiteOrganisateur('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'sortie[siteOrganisateur]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getSiteOrganisateur());
    }
